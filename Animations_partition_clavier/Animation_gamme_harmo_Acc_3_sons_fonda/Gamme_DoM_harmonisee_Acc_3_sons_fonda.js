...
var positiondepartcurseur = 105;
var to_tab =  [0, 1.8, 2.8, 3.6, 4.5, 5.6, 6.6, 7.6, 8.6, 9.6, 10.6, 11.7, 12.7, 13.7 , 14.9, 17.5 ]; // 200603: en secondes, array.length = 16; instruit depuis Trakax (logiciel video)
var poso_tab = [105, 260, 295, 345, 390, 445, 495, 540, 653, 700, 760, 810, 860, 913, 990, 1000]; // 200603: en pixels positionX des objets clés. Taille tableau: 13
...
function remettre_a_zero(){
		...
		document.getElementById("curseur_position").innerHTML = 'curseur (px): ' + 105;
}
